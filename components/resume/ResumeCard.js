  ...
  return (
    <div className="w-full h-1/3 group flex">
      <div className="w-10 h-[6px] bgOpacity mt-16 relative">
        ...
        >
          <span
            className="w-3 h-3 rounded-full bg-body-Color inline-flex
                group-hover:bg-designColor duration-300"
          ></span>
        </span>
      </div>
      <div
        className="w-full bg-black bg-opacity-20 hover:bg-opacity-3- duration-300
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm st-2 text-gray-400 group-hover:text-white duration-300">
              {subTitle}
            </p>
          </div>
          <div>
